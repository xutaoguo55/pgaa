...
PGAA is a Python and R software package for prioritizing heterogeneous single-cell transcriptional responses. It implements PGAA-W Wasserstein for full-distribution shifts and a PGAA-H histogram-shape diagnostic for responder-associated expression-shape changes. The Communications AI & Computing manuscript-support materials are included under `communications_ai_computing/` when this archive is unpacked.
