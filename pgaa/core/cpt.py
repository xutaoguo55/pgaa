"""Conditional permutation-test utilities for perturbation analysis.

This module contains experimental helpers for constructing conditional
null distributions when perturbation labels and latent cell-state
