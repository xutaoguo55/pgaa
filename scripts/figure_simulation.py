...
df = pd.read_csv(ROOT / "scripts" / "simulation_powers.csv")
...
print()
print("The Norman 2019 CEBPE example is therefore best interpreted as a")
print("narrow responder-associated ranking case where S₂ can improve selected")
print("target ranks despite weak full-program recovery. Combined z remains")
print("exploratory because S₁ and S₂ are dependent statistics.")
