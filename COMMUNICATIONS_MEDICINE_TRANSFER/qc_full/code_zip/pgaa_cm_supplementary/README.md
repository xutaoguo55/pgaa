...
PGAA is a Python and R software package for prioritizing heterogeneous single-cell transcriptional responses. It implements a Wasserstein statistic for full-distribution shifts and a persistent-homology statistic for responder-associated expression-shape changes. The Communications Medicine manuscript-support materials are included under `communications_medicine/` when this archive is unpacked.
